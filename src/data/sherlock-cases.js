...
export const SHERLOCK_CASES_LIST = [
  {
    id: "sherlock_case_1",
    title: "Vụ Án 1: Cái Chết Của Sherlock Holmes",
    setting_date: "Ngày 2 tháng 12 năm 1893",
    difficulty: "Dễ (Tân thủ)",
    diffLevel: "easy",
    desc: "Vụ hỏa hoạn và án mạng bí ẩn tại căn hộ 221B Baker Street. Kịch bản nhập môn giúp thám tử làm quen với hệ thống tra cứu bản đồ, danh bạ và điều tra hiện trường."
  },
  {
    id: "sherlock_case_2",
