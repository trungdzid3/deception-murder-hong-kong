export const SHERLOCK_CASE_2 = {
  ...
  "directory": [
    ...
    { "name": "Robins, Olivia", "category": "Nhân chứng", "address": "50 NW Baker St", "code": "50NW", "desc": "Nhân chứng sống đối diện 221B Baker Street." },
    { "name": "Charles Darwin (Bác sĩ)", "category": "Y tế", "address": "27 EC Fleet St", "code": "27EC", "desc": "Phòng khám tư nhân lâu đời." },
    { "name": "John Watson (Bác sĩ)", "category": "Đồng sự Holmes", "address": "221B Baker Street", "code": "221B", "desc": "Bác sĩ quân y và người ghi chép các kỳ án." },
    ...
    { "name": "Văn phòng phẩm A. W. Faber", "category": "Tiệm văn phòng phẩm", "address": "28 WC Strand", "code": "28WC", "desc": "Nơi Sherlock Holmes ẩn náu bí mật." }
  ]
};
